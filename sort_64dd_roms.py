...
WORKBOOK_PATH = Path("64DD Game List.xlsx")
SHEET_NAME = "Sheet1"

IN_DIR = Path("IN_64DD")
OUT_DIR = Path("OUT.64DD")
        ...
        try:
            ...
            if sha1 in seen_sha1:
                ...
                if DELETE_DUPLICATES:
                    ...
                    dest = unique_destination(region_dir(entry.region), entry.title, ".ndd")
                    shutil.move(str(path), str(dest))
            ...
            dest = unique_destination(out_folder, entry.title, ".ndd")
